...
const TimeSyncDialogBodyWhenClocksAreInSync = ({ clockSkew }) => {
  ...
  return (
    <DialogContent className={classes.content}>
      <Box my={2}>
        <DialogContentText>
          The internal clock of your device and the clock of the MIT server are
          now in sync:
        </DialogContentText>
      </Box>
...
const TimeSyncDialogBodyWhenClocksAreNotInSync = ({ clockSkew }) => {
  ...
  return (
    <DialogContent className={classes.content}>
      ...
      <DialogContentText>
        The internal clock of your device and the clock of the MIT server you
        have connected to are not in sync:
      </DialogContentText>
      <ServerAndClientClockComparison clockSkew={clockSkew} />
      <DialogContentText>
